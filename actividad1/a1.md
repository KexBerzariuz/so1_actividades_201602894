...
| ------------- |:-------------:| -----:|
| Descripcion     | Es un modo restringido  que los programas de aplicación ejecutan y comienzan. |
El Modo Kernel es el modo privilegiado, al que ingresa la computadora cuando accede a los recursos de hardware. |
